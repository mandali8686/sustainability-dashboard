...
const CompostToDining = () => {
  ...
  return (
    ...
    <a href="/contact">Contact Us</a>
      ...
      <img className='icon-dining' src='recycling.png' alt='recycling'/>
      ...
      <ul>
        <li>Collecting, processing, and converting waste materials into new products</li>
        <br></br>
        <li>Benefits</li>
        
        <ul>
          <li>Reduces the amount of waste that goes to landfills</li>
          <li>Conserves natural resources</li>
          <li>Saves energy</li>
        </ul>
        <br></br>
        <li>At Vanderbilt, you'll find designated bins for materials like paper, plastic, metal, and glass, which are then collected and sent to recycling centers</li>
        </ul>
